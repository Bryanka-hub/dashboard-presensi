...
import { deleteAbsen } from "@/lib/action";
...
export const DeleteButton = ({id}:{id:string}) => {
    const DeleteAbsenWithId = deleteAbsen.bind(null, id);
    return (
        <form action={DeleteAbsenWithId}>
